...
def generate_qrels(system_instructions: str, instruction_pattern: str, fn: str):
    ...
    for idx, hr_table in enumerate(human_rated_tables):
        ...
        system_instruction_encoded = enc.encode(system_instructions_sub)
...
if __name__ == '__main__':
    ...
    generate_qrels(system_instructions, instruction_pattern, "../gpt_judgements/ex_qrels_bin_topic_in_sys.txt")